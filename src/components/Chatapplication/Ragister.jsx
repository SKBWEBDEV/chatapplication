      ...
      <div className="md:flex md:items-center ">
        <div className="md:w-[50%] flex md:justify-end justify-center">
          ...
          <div className="relative mt-[40px]">
            ...
            <input className=" py-[15px] pl-[65px] outline-0 md:pr-[66px] md:w-[368px] font-secondary text-[20px] font-semibold 
            border-[#B8B8CE] rounded-[8px] border-3 text-[#11175D]" type="email"
            onChange={handleEmail}
            value={email}
            placeholder="Ladushing691@gmail.com "/>

            <p className="mt-3 bg-gray-600 text-white font-bold text-center md:w-[368px] w-80 rounded-[8px]">{errorEmail}</p>
           ...
           <div className="relative mt-[40px]">
            ...
            <p className="text-[#585D8E] text-[13px] font-secondary font-semibold absolute top-[-8px] left-[45px] bg-white w-30 text-center tracking-[2px]">Ful name</p>
              <p className="mt-3 bg-gray-600 text-white font-bold text-center md:w-[368px] w-80 rounded-[8px]">{errorName}</p>
           ...
           <div className="relative mt-[40px]">
            ...
            <p className="mt-3 bg-gray-600 text-white font-bold text-center md:w-[368px] w-80 rounded-[8px]">{passwordError}</p>
          </div>
           ...
           <div className="mt-[40px] ">
            ...
            <p className="mt-[30px] text-[#03014C] md:ml-22 text-[16px] md:text-[13px] font-primary font-normal">Already  have an account ? 
              <Link to= "/login"><span className="text-[#EA6C00]">Sign I n
              </span></Link>
              </p>
           </div>
